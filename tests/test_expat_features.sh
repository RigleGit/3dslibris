...
CCFLAGS="-DXML_STATIC -DHAVE_MEMMOVE -DXML_POOR_ENTROPY -DXML_DTD=$DTD -DXML_GE=1 -DXML_NS=$NS -DXML_CONTEXT_BYTES=$CONTEXT -DHAVE_GETRANDOM -DHAVE_SYS_RANDOM_H -I$ROOT/include -I$ROOT/third_party/expat"
