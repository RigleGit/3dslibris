...
CCFLAGS="-DXML_STATIC -DHAVE_MEMMOVE -DXML_POOR_ENTROPY -I$ROOT/include -I$ROOT/third_party/minizip -I$ROOT/third_party/minizip/include -I$ROOT/third_party/expat"
...
cc -c $CCFLAGS "$ROOT/third_party/expat/loadlibrary.c" -o "$OUTDIR/loadlibrary.o"
cc -c $CCFLAGS "$ROOT/third_party/expat/xmlparse.c" -o "$OUTDIR/xmlparse.o"
cc -c $CCFLAGS "$ROOT/third_party/expat/xmlrole.c" -o "$OUTDIR/xmlrole.o"
cc -c $CCFLAGS "$ROOT/third_party/expat/xmltok.c" -o "$OUTDIR/xmltok.o"
cc -c $CCFLAGS "$ROOT/third_party/expat/xmltok_impl.c" -o "$OUTDIR/xmltok_impl.o"
cc -c $CCFLAGS "$ROOT/third_party/expat/xmltok_ns.c" -o "$OUTDIR/xmltok_ns.o"
